...
# Check that '$KBOX create' contains 'drupal7' as a choice
@test "Check that '$KBOX create' contains 'drupal7' as a choice" {
  $KBOX create | grep drupal7
}

# Check that '$KBOX create' contains 'drupal8' as a choice
@test "Check that '$KBOX create' contains 'drupal8' as a choice" {
  $KBOX create | grep drupal8
}

# Check that '$KBOX create' contains 'backdrop' as a choice
@test "Check that '$KBOX create' contains 'backdrop' as a choice" {
  $KBOX create | grep backdrop
}

# Check that '$KBOX create' contains 'wordpress' as a choice
@test "Check that '$KBOX create' contains 'wordpress' as a choice" {
  $KBOX create | grep wordpress
}
