...
# Check that we have a Backdrop database.
@test "Check that we have a Backdrop database." {
  ...
  $DOCKER exec ${PHP_BACKDROP_NAME}_appserver_1 mysql -e 'SHOW DATABASES;' | grep backdrop
